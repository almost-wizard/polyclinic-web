...
public class ApproveVacationCommand extends ActionCommand {
    ...
    public ApproveVacationCommand(HttpServletRequest request, HttpServletResponse response) {
    ...
    public void execute() throws ServletException, IOException {
        ...
        try {
            ...
            isApproved = vacationApplicationDao.approve(doctorId, startDate, endDate);
        } catch (Exception ignored) {

        }

        if (!isApproved) {
            request.setAttribute("errorMessage", MessageManager.get("schedules.approve.error"));
        }
