...
public class BlockUserCommand extends ActionCommand {
    ...
    public BlockUserCommand(HttpServletRequest request, HttpServletResponse response) {
    ...
    public void execute() throws ServletException, IOException {
        ...
        boolean isDeleted = userDao.block(id);
        if (!isDeleted) {
            request.setAttribute("errorMessage", MessageManager.get("user.block.error"));
        }
