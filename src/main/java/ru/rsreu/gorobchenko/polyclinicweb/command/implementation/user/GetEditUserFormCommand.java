...
public class GetEditUserFormCommand extends ActionCommand {
    private static final String PARAM_NAME_USER_ID = "userId";

    public GetEditUserFormCommand(HttpServletRequest request, HttpServletResponse response) {
